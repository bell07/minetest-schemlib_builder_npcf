Builder that walk around and build building
...
dependencies: 
  ...
  - npcf https://github.com/bell07/minetest-npcf
    npcf mod only, not the whole pack
    The upstream version does not work till the movement framework is not merged
